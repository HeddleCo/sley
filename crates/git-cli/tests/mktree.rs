...
fn mktree_basic_and_z_modes_match_upstream_git() {
    ...
    let result = (|| {
        ...
        let expected_output = run_with_stdin("git", &expected, &["mktree"], input.as_bytes());
        ...
        let expected_tree = run_success("git", &expected, &["cat-file", "-p", &actual_tree]);
        let actual_tree = run_success("git", &actual, &["cat-file", "-p", &actual_tree]);
...
fn mktree_missing_commit_and_batch_modes_match_upstream_git() {
    ...
    let result = (|| {
        ...
        let expected_output =
            run_with_stdin("git", &expected, &["mktree"], missing_blob.as_bytes());
        ...
        let expected_output =
            run_with_stdin("git", &expected, &["mktree"], commit_entry.as_bytes());
        ...
        let expected_output =
            run_with_stdin("git", &expected, &["mktree", "--batch"], batch.as_bytes());
        let actual_output =
