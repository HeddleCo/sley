...
fn update_ref_stdin_basic_commands_match_upstream_git() {
    ...
    let result = (|| {
        ...
        let actual_output = run_with_stdin(env!("CARGO_BIN_EXE_git-rs"), &actual, &args, input);
        assert_same_output(actual_output, expected_output, &args);
        ...
        let actual_output = run_with_stdin(env!("CARGO_BIN_EXE_git-rs"), &actual, &z_args, &input);
        ...
        let actual_output =
            run_with_stdin(env!("CARGO_BIN_EXE_git-rs"), &actual, &no_deref_args, input);
        ...
        assert!(
            !actual
                ...
                .exists(),
            "git-rs left deleted symbolic ref"
        );
        ...
        let actual_output =
            run_with_stdin(env!("CARGO_BIN_EXE_git-rs"), &actual, &batch_z_args, &input);
        ...
        let actual_output =
            run_with_stdin(env!("CARGO_BIN_EXE_git-rs"), &actual, &no_batch_args, input);
