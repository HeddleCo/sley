...
fn describe_peel_commit(
    ...
    match object.object_type {
        ...
        ObjectType::Tag => {
            ...
            let commit = git_rev::peel_to_commit(db, format, &tag.object)?;
...
fn resolve_describe_commit(
    ...
    match object.object_type {
        ...
        ObjectType::Tag => git_rev::peel_to_commit(db, format, &oid),
        other => {
...
fn describe_dirty_suffix(
    ...
    match git_worktree::short_status(&worktree_root, git_dir, format) {
        Ok(entries) => {
...
fn describe_status_is_dirty(entries: &[git_worktree::ShortStatusEntry]) -> bool {
