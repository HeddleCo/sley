...
pub(crate) struct DiffOutputFormat(u32);

impl DiffOutputFormat {
    pub(crate) const RAW: Self = Self(0x0001);
    pub(crate) const DIFFSTAT: Self = Self(0x0002);
    pub(crate) const NUMSTAT: Self = Self(0x0004);
    pub(crate) const SUMMARY: Self = Self(0x0008);
    pub(crate) const PATCH: Self = Self(0x0010);
    pub(crate) const SHORTSTAT: Self = Self(0x0020);
    pub(crate) const DIRSTAT: Self = Self(0x0040);
    pub(crate) const NAME_ONLY: Self = Self(0x0100);
    pub(crate) const NAME_STATUS: Self = Self(0x0200);
    pub(crate) const CHECK: Self = Self(0x0400);
    pub(crate) const NO_OUTPUT: Self = Self(0x0800);
...
pub(crate) struct DiffOptions {
    pub(crate) output_format: DiffOutputFormat,
    ...
    pub(crate) dirstat: Option<DirstatOptions>,
    pub(crate) dirstat_cli_params: Vec<String>,
    pub(crate) context: Option<usize>,
    pub(crate) reverse: bool,
    pub(crate) pickaxe: Option<String>,
    pub(crate) pickaxe_all: bool,
    pub(crate) pickaxe_regex: bool,
    pub(crate) find_object_values: Vec<String>,
    ...
    pub(crate) diff_relative: DiffRelativeMode,
    ...
    pub(crate) rename_empty: bool,
    pub(crate) inexact_renames: bool,
...
pub(crate) enum DiffRelativeMode {
    Off,
    Cwd,
    Prefix(String),
}
...
pub(crate) fn diff_pickaxe_requires_non_empty_error() -> GitError {
