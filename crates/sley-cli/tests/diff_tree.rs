...
//!
//! Each case runs the same arguments through both `git` and our `sley`
...
/// generated object ids are deterministic across `git` and `sley`.
...
///
/// The similarity *percentage* is produced by the shared `sley_diff_merge`
