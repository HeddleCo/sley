...
fn sley(cwd: &Path, args: &[&str]) -> Vec<u8> {
    run_success(sley_testkit::sley_bin!(), cwd, args)
}
...
fn stash_list_matches_upstream_git() {
    let root = unique_temp_dir("stash-list");
    {
        ...
        for args in [
            ...
            vec!["stash", "list", "--grep-reflog=.", "-F"],
            vec!["stash", "list", "--grep-reflog=.", "--basic-regexp"],
            vec!["stash", "list", "--grep-reflog=one", "--invert-grep"],
            vec!["stash", "list", "--grep-reflog=one", "--grep=two"],
            vec![
                "stash",
                "list",
                "--grep-reflog=one",
            ...
            vec!["stash", "list", "--decorate=true"],
            vec!["stash", "list", "--decorate=1"],
            vec!["stash", "list", "--decorate=on"],
            vec!["stash", "list", "--decorate=yes"],
            ...
            assert_eq!(actual, expected, "sley stash output differed for {args:?}");
        }
        for args in [
            ...
            ["stash", "list", "--date"].as_slice(),
            ["stash", "list", "--date=bad"].as_slice(),
            ["stash", "list", "--no-date"].as_slice(),
            ["stash", "list", "--no-date=value"].as_slice(),
            ["stash", "list", "--no-encoding"].as_slice(),
            ["stash", "list", "--no-encoding=value"].as_slice(),
            ["stash", "list", "--no-abbrev=value"].as_slice(),
            ...
            ["stash", "list", "-Ffoo"].as_slice(),
            ["stash", "list", "-Efoo"].as_slice(),
            ["stash", "list", "-Pfoo"].as_slice(),
            ["stash", "list", "-ifoo"].as_slice(),
            ["stash", "list", "-F=foo"].as_slice(),
            ["stash", "list", "-E=foo"].as_slice(),
            ["stash", "list", "-P=foo"].as_slice(),
            ["stash", "list", "-i=foo"].as_slice(),
            ["stash", "list", "--no-grep-reflog"].as_slice(),
            ["stash", "list", "--no-grep-reflog=value"].as_slice(),
            ["stash", "list", "--no-author"].as_slice(),
            ["stash", "list", "--no-author=value"].as_slice(),
            ["stash", "list", "--no-committer"].as_slice(),
            ["stash", "list", "--no-committer=value"].as_slice(),
            ...
            ["stash", "list", "--no-color=value"].as_slice(),
            ["stash", "list", "--color-moved=bad"].as_slice(),
            ["stash", "list", "--color-moved-ws=bad"].as_slice(),
            ["stash", "list", "--color-moved-ws"].as_slice(),
            ["stash", "list", "--no-relative=value"].as_slice(),
            ["stash", "list", "--full-diff=value"].as_slice(),
            ["stash", "list", "--no-patch=value"].as_slice(),
            ["stash", "list", "--ext-diff=value"].as_slice(),
            ["stash", "list", "--no-ext-diff=value"].as_slice(),
            ["stash", "list", "--textconv=value"].as_slice(),
            ["stash", "list", "--no-textconv=value"].as_slice(),
            ["stash", "list", "--no-renames=value"].as_slice(),
            ["stash", "list", "--find-renames=value"].as_slice(),
            ["stash", "list", "-Mbad"].as_slice(),
            ["stash", "list", "--find-copies=value"].as_slice(),
            ["stash", "list", "-Cbad"].as_slice(),
            ["stash", "list", "--find-copies-harder=value"].as_slice(),
            ["stash", "list", "--no-find-copies-harder=value"].as_slice(),
            ["stash", "list", "--full-index=value"].as_slice(),
            ["stash", "list", "--diff-merges"].as_slice(),
            ["stash", "list", "--diff-merges=bad"].as_slice(),
            ["stash", "list", "--no-diff-merges=value"].as_slice(),
            ["stash", "list", "--break-rewrites=value"].as_slice(),
            ["stash", "list", "-Bbad"].as_slice(),
            ["stash", "list", "--irreversible-delete=value"].as_slice(),
            ["stash", "list", "--minimal=value"].as_slice(),
            ["stash", "list", "--patience=value"].as_slice(),
            ["stash", "list", "--histogram=value"].as_slice(),
            ["stash", "list", "--indent-heuristic=value"].as_slice(),
            ["stash", "list", "--no-indent-heuristic=value"].as_slice(),
            ["stash", "list", "--ignore-space-at-eol=value"].as_slice(),
            ["stash", "list", "--ignore-cr-at-eol=value"].as_slice(),
            ["stash", "list", "--ignore-space-change=value"].as_slice(),
            ["stash", "list", "--ignore-all-space=value"].as_slice(),
            ["stash", "list", "--ignore-blank-lines=value"].as_slice(),
            ["stash", "list", "--function-context=value"].as_slice(),
            ["stash", "list", "--no-prefix=value"].as_slice(),
            ["stash", "list", "--default-prefix=value"].as_slice(),
            ["stash", "list", "--ita-visible-in-index=value"].as_slice(),
            ["stash", "list", "--ita-invisible-in-index=value"].as_slice(),
            ["stash", "list", "--pickaxe-all=value"].as_slice(),
            ["stash", "list", "--pickaxe-regex=value"].as_slice(),
            ["stash", "list", "-Dvalue"].as_slice(),
            ["stash", "list", "-mvalue"].as_slice(),
            ["stash", "list", "-svalue"].as_slice(),
            ["stash", "list", "-bvalue"].as_slice(),
            ["stash", "list", "-wvalue"].as_slice(),
            ["stash", "list", "-Wvalue"].as_slice(),
            ...
            ["stash", "list", "--oneline=value"].as_slice(),
            ["stash", "list", "--show-signature=value"].as_slice(),
            ["stash", "list", "--no-show-signature=value"].as_slice(),
            ["stash", "list", "--notes=value"].as_slice(),
            ["stash", "list", "--show-notes=value"].as_slice(),
            ["stash", "list", "--notes="].as_slice(),
            ["stash", "list", "--show-notes=refs/notes/missing"].as_slice(),
            ["stash", "list", "--no-notes=value"].as_slice(),
            ["stash", "list", "--standard-notes=value"].as_slice(),
            ["stash", "list", "--no-standard-notes=value"].as_slice(),
            ["stash", "list", "--no-color-moved=value"].as_slice(),
            ["stash", "list", "--output-indicator-new"].as_slice(),
            ["stash", "list", "--output-indicator-new=abc"].as_slice(),
            ["stash", "list", "--output-indicator-old"].as_slice(),
            ["stash", "list", "--output-indicator-context"].as_slice(),
            ["stash", "list", "--ws-error-highlight=bad"].as_slice(),
            ["stash", "list", "--submodule=bad"].as_slice(),
            ["stash", "list", "--ignore-submodules=bad"].as_slice(),
            ["stash", "list", "--full-history=value"].as_slice(),
            ["stash", "list", "--dense=value"].as_slice(),
            ["stash", "list", "--sparse=value"].as_slice(),
            ["stash", "list", "--remove-empty=value"].as_slice(),
            ["stash", "list", "--left-right=value"].as_slice(),
            ["stash", "list", "--merges=value"].as_slice(),
            ["stash", "list", "--no-merges=value"].as_slice(),
            ["stash", "list", "--no-min-parents=value"].as_slice(),
            ["stash", "list", "--no-max-parents=value"].as_slice(),
            ["stash", "list", "--children"].as_slice(),
            ["stash", "list", "--children=value"].as_slice(),
            ["stash", "list", "--cherry-pick"].as_slice(),
            ["stash", "list", "--cherry-pick=value"].as_slice(),
            ["stash", "list", "--ancestry-path"].as_slice(),
            ["stash", "list", "--ancestry-path=value"].as_slice(),
            ["stash", "list", "--topo-order"].as_slice(),
            ["stash", "list", "--topo-order=value"].as_slice(),
            ["stash", "list", "--date-order"].as_slice(),
            ["stash", "list", "--date-order=value"].as_slice(),
            ["stash", "list", "--author-date-order"].as_slice(),
            ["stash", "list", "--author-date-order=value"].as_slice(),
            ["stash", "list", "--simplify-by-decoration"].as_slice(),
            ["stash", "list", "--simplify-by-decoration=value"].as_slice(),
            ["stash", "list", "--simplify-merges"].as_slice(),
            ["stash", "list", "--simplify-merges=value"].as_slice(),
            ["stash", "list", "--skip=bad"].as_slice(),
            ["stash", "list", "--skip"].as_slice(),
            ["stash", "list", "--max-count=bad"].as_slice(),
            ["stash", "list", "--max-count"].as_slice(),
            ["stash", "list", "--no-max-count"].as_slice(),
            ["stash", "list", "--no-max-count=value"].as_slice(),
            ["stash", "list", "--no-skip"].as_slice(),
            ["stash", "list", "--no-skip=value"].as_slice(),
            ["stash", "list", "--min-parents=bad"].as_slice(),
            ["stash", "list", "--max-parents=bad"].as_slice(),
            ["stash", "list", "--grep-reflog=["].as_slice(),
            ...
            ["stash", "list", "--no-max-age"].as_slice(),
            ["stash", "list", "--no-max-age=value"].as_slice(),
            ["stash", "list", "--no-min-age"].as_slice(),
            ["stash", "list", "--no-min-age=value"].as_slice(),
            ["stash", "list", "--no-since"].as_slice(),
            ["stash", "list", "--no-since=value"].as_slice(),
            ["stash", "list", "--no-after"].as_slice(),
            ["stash", "list", "--no-after=value"].as_slice(),
            ["stash", "list", "--no-until"].as_slice(),
            ["stash", "list", "--no-until=value"].as_slice(),
        ...
        for args in [
            ...
            let actual = sley(&identity, &args);
            assert_eq!(
                actual, expected,
                "sley stash identity filter output differed for {args:?}"
            );
        }
        ...
        for args in [
            ...
            let actual = sley(&ages, &args);
            assert_eq!(
                actual, expected,
                "sley stash age filter output differed for {args:?}"
            );
        }
    };
...
fn stash_create_matches_upstream_git() {
    let root = unique_temp_dir("stash-create");
    {
        ...
        let actual_output =
            run_output_with_fixed_identity(sley_testkit::sley_bin!(), &clean_actual, &clean_args);
        ...
        for (name, setup, args) in [
            ...
            let actual_output =
                run_output_with_fixed_identity(sley_testkit::sley_bin!(), &actual, &args);
            assert_eq!(
            ...
            for check_args in [
                ...
                let actual_output = run_output(sley_testkit::sley_bin!(), &actual, &check_args);
...
fn stash_apply_matches_upstream_git_for_clean_head() {
    ...
    for (name, setup, push_args, apply_args) in [
        ...
        let actual_output = run_output(sley_testkit::sley_bin!(), &actual, &apply_args);
        assert_eq!(
            actual_output.status.code(),
            expected.status.code(),
...
fn stash_pop_matches_upstream_git_for_clean_head() {
    ...
    for (name, setup, push_args, pop_args) in [
        ...
        let actual_output = run_output(sley_testkit::sley_bin!(), &actual, &pop_args);
        assert_eq!(
            actual_output.status.code(),
            expected.status.code(),
...
fn stash_branch_matches_upstream_git_for_clean_head() {
    ...
    for (name, setup, push_args, branch_args) in [
        ...
        let actual_output = run_output(sley_testkit::sley_bin!(), &actual, &branch_args);
        assert_eq!(
            actual_output.status.code(),
            expected.status.code(),
    ...
    let template = root.join("template");
    {
        ...
        for (name, args) in [
            ...
            if matches!(name, "append" | "same-oid-noop") {
                ...
                sley(&actual, &["stash", "store", stash_oid.as_str()]);
            }
...
fn stash_list_empty_matches_upstream_git() {
    ...
    fs::create_dir_all(&root).expect("create temp repo");
    {
        ...
        for args in [
            ...
            assert_eq!(
                actual, expected,
                "sley empty stash output differed for {args:?}"
            );
        }
    };
    let _ = fs::remove_dir_all(&root);
...
fn stash_show_matches_upstream_git() {
    let root = unique_temp_dir("stash-show");
    {
        ...
        for args in [
            ...
            assert_eq!(
                actual, expected,
                "sley stash show output differed for {args:?}"
            );
        }
...
fn stash_show_untracked_flags_match_upstream_git() {
    ...
    let tracked_only = root.join("tracked-only");
    {
        ...
        for args in [
            ...
            let actual = sley(&untracked, &args);
            assert_eq!(
                actual, expected,
                "sley stash show untracked output differed for {args:?}"
            );
        }
        for args in [
            ...
            let actual = run_output(sley_testkit::sley_bin!(), &untracked, args);
            assert_same_output(actual, expected, args);
        }
        ...
        for args in [
            ...
            let actual = sley(&tracked_only, &args);
            assert_eq!(
                actual, expected,
                "sley tracked-only stash output differed for {args:?}"
            );
        }
        let args = ["stash", "show", "--quiet", "--only-untracked"];
        let expected = run_output(sley_testkit::oracle_git(), &tracked_only, &args);
        let actual = run_output(sley_testkit::sley_bin!(), &tracked_only, &args);
        assert_same_output(actual, expected, &args);
    };
    let _ = fs::remove_dir_all(&root);
}
...
fn stash_show_empty_and_errors_match_upstream_git() {
    ...
    let template = root.join("template");
    {
        ...
        for (name, args) in [
            ...
            let expected = run_output(sley_testkit::oracle_git(), &upstream, &args);
            let actual = run_output(sley_testkit::sley_bin!(), &actual, &args);
            assert_same_output(actual, expected, &args);
        }
        ...
        let actual = run_output(sley_testkit::sley_bin!(), &empty, &args);
        assert_same_output(actual, expected, &args);
    };
    let _ = fs::remove_dir_all(&root);
}
