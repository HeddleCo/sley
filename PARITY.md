...
- Minimal `stash list` support over `refs/stash` reflogs, including default
  ...
  patch-suppression, no-graph toggle, ext-diff/textconv, full-diff,
  rename/copy detection, relative path,
  ...
  history-limiting, ordering, notes/source/signature value rejections,
